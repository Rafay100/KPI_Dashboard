...
export class MondayAdapter extends BaseAdapter {
  ...
  async createRecord(
    ...
    throw new Error(`Write operations are not supported by the Monday.com adapter (table: ${tableName}).`);
  }
  ...
  async updateRecord(
    ...
    throw new Error(`Write operations are not supported by the Monday.com adapter (table: ${tableName}, id: ${id}).`);
  }
