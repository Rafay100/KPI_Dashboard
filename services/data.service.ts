  ...
  async createRecord<T extends FieldSet>(
    ...
    if (lowerTable === "kpis") {
      ...
      const localTask: Task = {
        ...
        assignedToId: String(fields.AssigneeId || fields.assigneeId || fields.Assignee || ""),
        assignedTo: String(fields.AssigneeName || fields.assigneeName || fields.Assignee || ""),
      ...
      const localEmployee: Employee = {
        ...
        position: String(fields.Position || fields.position || fields.Role || fields.role || ""),
        departmentId: String(fields.DepartmentId || fields.departmentId || ""),
        department: String(fields.Department || fields.department || ""),
        avatar: String(fields.Avatar || fields.avatar || fields.AvatarUrl || fields.avatarUrl || ""),
        team: String(fields.Team || fields.team || ""),
        overallScore: 0,
        totalKPIs: 0,
        completedKPIs: 0,
        lastUpdated: new Date().toISOString(),
      ...
      const localDept: Department = {
        ...
        totalKPIs: 0,
        completedKPIs: 0,
        headOfDepartment: String(fields.HeadOfDepartment || fields.headOfDepartment || fields.Manager || fields.manager || ""),
        lastUpdated: new Date().toISOString(),
        createdAt: new Date().toISOString(),
      };
      ...
      const localAchievement: Achievement = {
        ...
        description: String(fields.Description || fields.description || ""),
        points: Number(fields.Points || fields.points || 0),
        employeeId: String(fields.EmployeeId || fields.employeeId || ""),
        employeeName: String(fields.EmployeeName || fields.employeeName || ""),
        category: (String(fields.Category || fields.category || "excellence").toLowerCase()) as Achievement["category"],
        achievedAt: String(fields.AchievedAt || fields.achievedAt || fields.DateEarned || fields.dateEarned || new Date().toISOString()),
        badge: String(fields.Badge || fields.badge || fields.BadgeUrl || fields.badgeUrl || ""),
        createdAt: new Date().toISOString(),
      };
